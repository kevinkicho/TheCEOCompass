    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setShowModal(false)}>
          <div className="w-full max-w-lg rounded-xl dark:bg-dark-900 bg-white dark:bg-dark-900 p-6 shadow-2xl animate-slide-up" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-dark-600 dark:text-dark-300 dark:text-dark-600 mb-5">This feature needs the Python backend and LLM API keys. Here&apos;s what you get running locally:</p>
            ...
            <div className="space-y-3 text-left text-dark-600 dark:text-dark-300 dark:text-dark-600 mb-5">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-dark-500 dark:text-dark-400 dark:text-dark-500">Log decisions, record outcomes over time, and see your calibration analytics</p>
                </div>
              </div>
              <div className="flex gap-3">
                <span className="text-lg shrink-0">🧠</span>
                <div>
                  ...
                  <p className="text-xs text-dark-500 dark:text-dark-400 dark:text-dark-500">All 57 frameworks with ~200 concepts, definitions, formulas, and 3 real-world examples each</p>
                </div>
              </div>
            </div>

            <div className="rounded-lg dark:bg-dark-900 bg-dark-50 dark:bg-dark-900 p-4 mb-4">
