...
export function BackendRequiredModal({ show, onClose, feature }: { show: boolean; onClose: () => void; feature: string }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={onClose}>
      <div className="w-full max-w-md rounded-xl dark:bg-dark-900 bg-white dark:bg-dark-900 p-6 shadow-2xl animate-slide-up" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={onClose} className="text-dark-400 dark:text-dark-500 hover:text-dark-600 dark:text-dark-300 dark:text-dark-600 text-lg">&times;</button>
        </div>

        <p className="text-dark-600 dark:text-dark-300 dark:text-dark-600 mb-4">
        ...
        <div className="rounded-lg dark:bg-dark-900 bg-dark-50 dark:bg-dark-900 p-4 mb-4">
          <p className="text-xs font-semibold text-dark-700 dark:text-dark-300 dark:text-dark-600 mb-2">Quick setup — 2 minutes</p>
