            ...
            <div className="space-y-3 text-left text-dark-600 mb-5 dark:text-dark-300">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-dark-500 dark:text-dark-300">Log decisions, record outcomes over time, and see your accuracy-vs-confidence calibration chart</p>
                </div>
              </div>
              <div className="flex gap-3">
                <span className="text-lg shrink-0">🧠</span>
                <div>
                  ...
                  <p className="text-xs text-dark-500 dark:text-dark-300">All 57 frameworks with ~200 concepts, definitions, formulas, and 3 real-world CEO examples each</p>
                </div>
              </div>
            </div>
