  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-4 pt-8 sm:pt-24 pb-12 sm:pb-24 text-center">
        ...
        <p className="mx-auto mb-10 max-w-2xl text-lg text-dark-500 dark:text-dark-400 dark:text-dark-500">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link
            href="/frameworks"
            className="rounded-lg border border-dark-300 dark:border-dark-600 px-6 py-3 font-medium text-dark-700 dark:text-dark-300 dark:text-dark-600 hover:bg-dark-50 dark:hover:bg-dark-800"
          >
            Explore Frameworks
          </Link>
        </div>
      ...
      {/* Stats — clickable */}
      <section className="border-t border-dark-100 dark:border-dark-800 bg-dark-50 dark:bg-dark-900">
        <div className="mx-auto grid max-w-4xl grid-cols-3 divide-x divide-dark-200 px-4 py-10">
          <button
            onClick={() => setActiveCategory(null)}
            className="text-center hover:bg-white/50 dark:hover:bg-dark-700 transition rounded-lg py-2"
          >
            <p className="text-3xl font-bold text-primary-600">{frameworks.length}</p>
            <p className="text-sm text-dark-500 dark:text-dark-400 dark:text-dark-500">Frameworks</p>
          </button>
          <button
          ...
          >
            ...
            <p className="text-sm text-dark-500 dark:text-dark-400 dark:text-dark-500">Domains</p>
          </button>
          <Link href="/scenarios" className="text-center hover:dark:bg-dark-900 bg-white dark:hover:bg-dark-900/50 dark:hover:bg-dark-700 transition rounded-lg py-2 block">
            <p className="text-3xl font-bold text-primary-600">{scenarioCount}</p>
            <p className="text-sm text-dark-500 dark:text-dark-400 dark:text-dark-500">Scenarios</p>
          </Link>
        </div>
      </section>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className={`rounded-full px-4 py-1.5 text-xs font-medium transition ${
              !activeCategory ? "bg-primary-600 text-white" : "bg-dark-100 text-dark-600 dark:text-dark-300 dark:text-dark-600 hover:bg-dark-200 dark:hover:bg-dark-600"
            }`}
          >
            All
          </button>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {displayedFrameworks.map((fw) => (
            <Link
              ...
              className="rounded-xl border border-dark-200 dark:border-dark-700 p-6 transition hover:border-primary-300 hover:shadow-md"
            >
              <div className="mb-3 flex items-center gap-2">
                <span className="rounded-full bg-primary-100 px-2 py-0.5 text-xs font-medium text-primary-700">
                  {fw.category.replace(/-/g, " ")}
                </span>
                <span className="rounded-full bg-dark-100 dark:bg-dark-800 px-2 py-0.5 text-xs text-dark-600 dark:text-dark-300 dark:text-dark-600">
                  {fw.difficulty}/5
                </span>
              </div>
