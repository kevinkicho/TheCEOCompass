    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-4 pt-8 sm:pt-24 pb-12 sm:pb-24 text-center">
        ...
        <p className="mx-auto mb-10 max-w-2xl text-lg text-dark-500 dark:text-dark-300">
          {frameworks.length > 0
            ? `Your compass through ${frameworks.length} frameworks across ${categories.length} domains ΓÇö decision-making, financial analysis, negotiation, competitive strategy, operations, and more.`
